...
export function AnthropicKeyForm({ isConfigured }: AnthropicKeyFormProps) {
      ...
      <div className="flex items-start justify-between mb-4">
        <div>
          <div className="flex items-center gap-2 mb-1">
            <span className="text-sm font-semibold text-gray-900">Anthropic API Key</span>
            {isConfigured && !saved && (
          ...
          <p className="text-xs text-gray-500">
            Used for AI article rewrites, bulk translation, and semantic search.
          </p>
          <code className="text-xs text-gray-400 font-mono">ANTHROPIC_API_KEY</code>
        </div>
        <a
      ...
      <form onSubmit={handleSave} className="space-y-3">
        <div className="relative">
          <input
            ...
            placeholder={isConfigured ? "Paste new key to replace…" : "Paste your Anthropic API key (sk-ant-…)"}
