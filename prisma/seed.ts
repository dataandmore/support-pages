...
const categories = [
  { slug: "getting-started", icon: "🚀", position: 0, isGated: false, translations: {
  ...
  { slug: "it-setup-onboarding", icon: "🔧", position: 1, isGated: false, translations: {
  ...
  { slug: "using-the-platform", icon: "📊", position: 2, isGated: false, translations: {
  ...
  { slug: "organisation-rollout", icon: "🏢", position: 3, isGated: false, translations: {
  ...
  { slug: "operations-updates", icon: "🔄", position: 5, isGated: false, translations: {
  ...
  { slug: "video-library", icon: "🎬", position: 6, isGated: false, translations: {
...
async function main() {
  ...
  console.log("✅ 7 categories seeded with all 4 locale translations")
}
